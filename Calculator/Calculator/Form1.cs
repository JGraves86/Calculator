    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCal_Click(object sender, EventArgs e)
        {
            ...
            if (rdSquare.Checked)
            {
                ...
                // txtLOp.Text = Convert.ToDouble(txtLOp.Text).ToString();
                //lblRes = (Convert.ToInt32(txtLOp.Text)) ( Convert.ToDouble(txtLOp.Text)).ToString();
            ...
            if (rdRaise.Checked)
            {
                ...
                //lblExpr.Text = (Math.Pow(Convert.ToDouble(txtLOp.Text, txtROp.Text)).ToString()); 
